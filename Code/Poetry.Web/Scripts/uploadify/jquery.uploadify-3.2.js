        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var settings = $.extend({
                    ...
                    swf: '/media/js/uploadify/uploadify.swf',  // The path to the uploadify SWF file
                    uploader: "/api/Icon/UploadFile",  // The path to the server-side upload script
                    button_image_url: "javascript:;",
                    // Options
                    ...
                    fileTypeDesc: '不超过4mb的图片文件',        // The description for file types in the browse dialog
                    fileTypeExts: '*.gif;*.jpg;*.jpeg;*.png',              // Allowed extensions in the browse dialog (server-side validation should also be used)
